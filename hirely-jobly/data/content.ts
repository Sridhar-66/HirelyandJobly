...
export const site = {
  ...
  phone: "+91 95536 85395",
  whatsapp: "+919553685395",
...
export const trustBadges = [
  ...
  { label: "Hyderabad Campus", desc: "Madhapur Tech Campus", icon: "Building2" },
...
export const twoFeatureCards = [
  {
    ...
    desc: "Intensive in-person training with daily mentor guidance at our state-of-the-art tech campus in Madhapur.",
    cta: "Visit Campus",
    link: "/contact#centers",
    footerLabel: "Madhapur Tech Campus",
    features: [
...
export const plans = [
  {
    ...
    badge: "Self-Paced",
    popular: false,
    desc: "Introductory pricing for our first cohort",
    price: "₹2,999",
    originalPrice: "₹5,999",
    cta: "Pay Now",
    f: [
      "Recorded content sequences",
  ...
  {
    name: "Live Mentor Track",
    badge: "MOST CHOSEN",
    popular: true,
    desc: "Our flagship program",
    price: "₹4,999",
    originalPrice: "₹9,999",
    cta: "Pay Now",
    f: [
      "Live instructor-led sessions + recordings",
      "Dedicated mentor — weekly 1:1 & doubt support",
      "Structured week-by-week curriculum & assessments",
      "Real-world capstone project + GitHub portfolio",
      "Resume builder + LinkedIn profile enhancement",
  ...
  {
    name: "Career Launch Track",
    badge: "Career Launch",
    popular: false,
    desc: "Everything in Live Mentor, plus:",
    price: "₹8,999",
    originalPrice: "₹16,999",
    cta: "Pay Now",
    f: [
      "Career assessment & personalized roadmap",
...
export const faqs = [
  ...
  },
  {
    ...
    a: "We offer both! You can attend in-person lab sessions at our Madhapur (HITEC City) campus in Hyderabad, or attend live interactive classes online from anywhere with real-time TA support.",
    category: "admissions",
  },
  {
  ...
  },
  {
    ...
    a: "Our programs are structured into 3 accessible tiers: Self-Paced Track (₹2,999), Live Mentor Track (₹4,999), and Career Launch Track (₹8,999). Zero-cost EMI options and merit scholarships are also available.",
    category: "admissions",
  },
  {
